...
const validateEmail = (email) => {
  ...
  // /^(([^<>()[\]\.,;:\s@\"]+(\.[^<>()[\]\.,;:\s@\"]+)*)|(\".+\"))@(([^<>()[\]\.,;:\s@\"]+\.)+[^<>()[\]\.,;:\s@\"]{2,})$/i
  ///^[^\s@]+@[^\s@]+\.[^\s@]+$/
  let reg =/^[A-Za-z]+.[A-Za-z]+@[A-Za-z]+.(net|org|com)$/;
  let tes1 = reg.test(email);
  return tes1;
};
/* ------------------------------------------------------------------------------------------------
CHALLENGE 6
...
const validatePhoneNumber = (phoneNumber) => {
  ...
  let reg =/^(\([0-9]{3}\)|[0-9]{3})[\s-]?[0-9]{3}[\s-]?[0-9]{4}$/;
  let tes1 = reg.test(phoneNumber);
  return tes1;
};
/* ------------------------------------------------------------------------------------------------
