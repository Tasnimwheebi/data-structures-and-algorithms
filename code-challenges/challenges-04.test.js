...
const isCapitalized = (str) => {
  // Solution code here...
  let newArr = [];
  let regex4 = /\b[A-Z]\w*/g;
  let matching = str.match(regex4);
  if (matching){
    newArr=str.match(regex4);
  }
